...
CREATE TABLE `professors` (
  ...
  CONSTRAINT `feedback_pr` FOREIGN KEY (`id`) REFERENCES `feedback_for_professors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `projects` (
  ...
  PRIMARY KEY (`id`,`finish_date`,`start_date`,`subject`,`name`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-03-09 17:54:58
